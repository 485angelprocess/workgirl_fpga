...
#                script (type 'verify_vga.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.verify_vga xil_defaultlib.glbl -o verify_vga_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./verify_vga_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key verify_vga_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc verify_vga_simv.daidir vcs_lib c.obj)
