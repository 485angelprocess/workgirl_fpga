...
#
# Script generated by Vivado on Sun Mar 09 12:51:36 -0400 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : verify_vga.sh
...
#
# Usage        : verify_vga.sh
#                verify_vga.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                verify_vga.sh [-reset_run]
#                verify_vga.sh [-reset_log]
#                verify_vga.sh [-help]
#
...
# script info
echo -e "verify_vga.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./verify_vga.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot verify_vga xil_defaultlib.verify_vga xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim verify_vga -key {Behavioral:sim_1:Functional:verify_vga} -tclbatch cmd.tcl -protoinst "protoinst_files/display_driver.protoinst" -protoinst "protoinst_files/verify_vga.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb verify_vga.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./verify_vga.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: verify_vga.sh [-help]\n\
Usage: verify_vga.sh [-step]\n\
Usage: verify_vga.sh [-lib_map_path]\n\
Usage: verify_vga.sh [-reset_run]\n\
Usage: verify_vga.sh [-reset_log]\n\
Usage: verify_vga.sh [-keep_index]\n\
Usage: verify_vga.sh [-noclean_files]\n\n\
