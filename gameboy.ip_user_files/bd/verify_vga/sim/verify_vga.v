...
//Date        : Sun Mar  9 12:51:35 2025
//Host        : MSI running 64-bit major release  (build 9200)
//Command     : generate_target verify_vga.bd
//Design      : verify_vga
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "verify_vga,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=verify_vga,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "verify_vga.hwdef" *) 
module verify_vga
   (clk,
    ext_reset_in,
    reset_indicator,
    ...
    vga_hsync,
    vga_vsync);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN verify_vga_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  ...
  verify_vga_lcd_to_vga_0_0 lcd_to_vga_0
  ...
  verify_vga_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  verify_vga_vga_driver_svga_0_0 vga_driver_svga_0
       (.clk(clk_wiz_0_clk_out1),
  ...
  verify_vga_vga_verify_0_0 vga_verify_0
       (.clk(clk_wiz_0_clk_out1),
