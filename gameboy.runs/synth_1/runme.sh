...
HD_PWD='C:/Users/magen/Documents/Programs/gameboy/gameboy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_driver_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_driver_wrapper.tcl
