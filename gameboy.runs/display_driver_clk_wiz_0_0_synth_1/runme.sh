...
HD_PWD='C:/Users/magen/Documents/Programs/gameboy/gameboy.runs/display_driver_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_driver_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_driver_clk_wiz_0_0.tcl
