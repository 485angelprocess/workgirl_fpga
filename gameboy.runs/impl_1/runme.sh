...
HD_PWD='C:/Users/magen/Documents/Programs/gameboy/gameboy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_driver_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_driver_wrapper.tcl -notrace
